...
namespace opml
{
	...
	{
		inline double overall_error(const OutputLayer& outputLayer, const vector3D&  target) override
		{
			double v = 0.0;
		...
		inline void apply(OutputLayer* outputLayer, const vector3D& target) override
		{
